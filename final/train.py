...
def main():
    ...
    parser.add_argument('-i','--init_from', type=str, default=None, help='pre-trained weights')
    parser.add_argument('-c','--centers', type=str, default=None, help='parameters of centers')
    parser.add_argument('-s','--save_dir', type=str, default='save_full/', help='directory to store checkpointed models')
    ...
    parser.add_argument('-pt','--prof_type', type=str, default='linear', help='type of profile coefficient')
    parser.add_argument('-ls','--lambda_s', type=float, default=1e-3, help='coefficient of sparsity penalty')
    parser.add_argument('-lm','--lambda_m', type=float, default=1e-4, help='coefficient of monotonicity-induced penalty')
...
def train(FLAG):
    ...
    model.sparsity_train(decay=FLAG.decay, 
                        l1_gamma=FLAG.lambda_s, 
